...
public class MotCleCommande {
	 ...
	 */
	private final static String commandesValides[] = {"aller", "quitter", "aide", "prendre", "deposer", "mesObjets", "objetsPiece", "tuerAvec", "adopter", "liberer", "mesChiens", "prendreChien", "deposerChien", "nourir", "chiensPiece", "objetsChien"};
